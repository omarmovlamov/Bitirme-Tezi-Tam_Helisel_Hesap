      ...
      <div className="w-full max-w-4xl bg-white rounded-3xl shadow-2xl p-10">
        ...
        >
          ...
          <div className="fi_1,571_hesaplari">
            <strong>
              <p>φ = π/2 = 1,571 için kesit tesirleri</p>
            </strong>
            <p>
          ...
          <div className="fi_0,785_hesaplari">
            <strong>
              <p>φ = π/4 = 0,785 için kesit tesirleri</p>
            </strong>
            <p>
          ...
          <div className="Beton_Celik_degerleri">
            <strong>
              <p>Beton ve çelik karakteristik değerleri : </p>
            </strong>
            <p>
              Fck = C =
              <input
          ...
          <div className="Ust_Uc_Betonarme_Hesabi">
            <strong>
              <p>Üst ankastre uçta betonarme hesap</p>
            </strong>
            <p>Üst uçta çekme</p>
            <p>
          ...
          <div className="Alt_Uc_Betonarme_Hesabi">
            <strong>
              <p>Alt ankastre uçta betonarme hesap</p>
            </strong>
            <p>Alt uçta çekme</p>
            <p>
              N= {Nmax} d= {x_YonuDegerResim} b= {b_basamakGenisligi}
